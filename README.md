...
- [`agents/coderabbit-operator.md`](agents/coderabbit-operator.md) - Step-7 operator for one generated CodeRabbit review, independent finding dialogues, resolved threads, and exact-final-head approval.
