...
| CodeRabbit | Model - `gpt-medium` single-review owner + per-comment fixer | Run one review generation and resolve every finding by a validated fix or exact rationale reply; do not request a follow-up review. |
