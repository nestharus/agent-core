...
workflow_dispatch_contract:
  ...
  expectations:
    ...
    - gates each phase advance on contract-validator acceptance, behavior-test passage, QA walkthrough proof, and deep rebuild verification
  ...
  outputs:
    ...
    - proof bundle covering behavior tests, QA walkthrough, deep rebuild, and package material
    - one proof-focused draft PR shipping the stabilized prototype
  non_goals:
