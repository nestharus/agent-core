...
workflow_dispatch_contract:
  ...
  outputs:
    ...
    - "P4 spawned-ticket carry-forward payloads with prototype_test_pr_url, prototype_test_branch, test_paths_or_node_ids, marker_reason, ticket_mapping, and implementation_acceptance_criterion"
  non_goals:
