...
- Dispatch a `gpt-high` reviewer with `answer.md` + `spawned-tickets.md` + the diff.
...
- Dispatch a `gpt-high` reviewer with the diff (`git diff main..HEAD`) and the dossier's `answer.md` + `evidence/`.
