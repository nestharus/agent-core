...
workflow_dispatch_contract:
  ...
  inputs:
    - "planning_root plus its exact sessions.active-wake.json path; direct callers pass P and feature callers pass F/routes"
  ...
  expectations:
    ...
    - "validates run_id and ticket_id as canonical safe tokens and proves every generated wake, prompt, and log path remains under the caller-supplied live runtime root"
