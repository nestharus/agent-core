...
8. Update the decision register with the loop decision, deciding inputs, ambiguity, and next action. If the source artifacts do not contain a loop decision, record `missing` and return `NEEDS_INPUT`.
