...
| Out-of-scope refactor request | See `agents/work-manager-operator.md` `## Out-of-scope refactor request`; manager-hackerman rejects broad pause when functional proof holds and carries residual debt. |
