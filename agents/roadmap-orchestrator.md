...
5. **Iterate until risk is all-LOW or the operator halts.** No cycle cap. If the operator wants to accept residual risk, provide additional direction, or abandon the layer, that decision is surfaced via `NEEDS_INPUT`, not forced by an iteration count.
