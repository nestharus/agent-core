...
This remains the production implementation PR writer. Prototype experiment-evidence PRs use the separate prototype writer path; that distinction does not change this operator's inputs or audience rules.
