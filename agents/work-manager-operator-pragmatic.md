...
| Out-of-scope refactor request | See `agents/work-manager-operator.md` `## Out-of-scope refactor request`; manager-pragmatic keeps a tiny-unblocker only when bounded and necessary, otherwise pause. |
