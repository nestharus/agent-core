...
workflow_dispatch_contract:
  ...
  inputs:
    - "caller_mode with repository/artifact roots, runtime-derived root UUID, cycle/scope/runtime identity, contract/report hashes, mode-specific artifact mapping, and explicit manifest/report/trace/result output paths"
...
7. Join actual child UUIDs/output hashes to stable expected nodes and freeze manifests.
8. Capture raw trace, run the independent process-tree audit, and require current PASS.
